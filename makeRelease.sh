...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore release.keystore -storepass ***REMOVED*** platforms/android/build/outputs/apk/android-release-unsigned.apk release
